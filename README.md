...
1. Load the data of interest into PeakSelector and ensure it is properly filtered. For example, set quality control settings such as sigma rtNPh < 0.06 or set bounds on the unwrapped z value.
